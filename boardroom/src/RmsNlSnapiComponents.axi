  ...
  CHAR bReturn
{
  ...
  RmsAssetOnlineParameterUpdate(assetClientKey, GetOnlineSnapiValue(dvMonitoredDevice))
  RmsAssetDataInitializedParameterUpdate(assetClientKey, GetDataInitializedSnapiValue(dvMonitoredDevice))

#IF_DEFINED HAS_POWER
  #IF_DEFINED HAS_LAMP
    IF([vdvDeviceModule,POWER_FB]) RmsAssetParameterSetValue(assetClientKey,'projector.lamp.power','On' );
    ELSE                           RmsAssetParameterSetValue(assetClientKey,'projector.lamp.power','Off');
  #ELSE
    IF([vdvDeviceModule,POWER_FB]) RmsAssetParameterSetValue(assetClientKey,'asset.power','On' );
...
#IF_DEFINED HAS_VOLUME
  IF([vdvDeviceModule,VOL_MUTE_FB] )  RmsAssetParameterEnqueueSetValue(assetClientKey, 'volume.mute'           , 'true' );
...
#IF_DEFINED HAS_GAIN
  IF([vdvDeviceModule,GAIN_MUTE_FB])  RmsAssetParameterEnqueueSetValue(assetClientKey, 'gain.mute'             , 'true' );
...
#IF_DEFINED HAS_PREAMP
  IF([vdvDeviceModule,LOUDNESS_FB] )  RmsAssetParameterEnqueueSetValue(assetClientKey, 'preamp.loudness'       , 'true' );
...
#IF_DEFINED HAS_DIALER
  IF([vdvDeviceModule,DIAL_OFF_HOOK_FB] )      RmsAssetParameterEnqueueSetValue(assetClientKey, 'dialer.hook'           , 'true' );
  ELSE                                         RmsAssetParameterEnqueueSetValue(assetClientKey, 'dialer.hook'           , 'false');

  IF([vdvDeviceModule,DIAL_AUTO_ANSWER_FB] )   RmsAssetParameterEnqueueSetValue(assetClientKey, 'dialer.auto.answer'    , 'true' );
  ...
  IF([vdvDeviceModule,DIAL_AUDIBLE_RING_FB])   RmsAssetParameterEnqueueSetValue(assetClientKey, 'dialer.ring.audible'   , 'true' );
...
#IF_DEFINED HAS_CONFERENCER
  IF([vdvDeviceModule,ACONF_PRIVACY_FB] )  RmsAssetParameterEnqueueSetValue(assetClientKey, 'conferencer.privacy'   , 'true' );
...
#IF_DEFINED HAS_CAMERA_LENS
  ...
  IF([vdvDeviceModule,AUTO_FOCUS_FB] )      RmsAssetParameterEnqueueSetValue(assetClientKey, 'camera.focus.auto'     , 'true' );
  ELSE                                      RmsAssetParameterEnqueueSetValue(assetClientKey, 'camera.focus.auto'     , 'false');

  IF([vdvDeviceModule,AUTO_IRIS_FB]  )      RmsAssetParameterEnqueueSetValue(assetClientKey, 'camera.iris.auto'      , 'true' );
...
#IF_DEFINED HAS_DISC_TRANSPORT
  SELECT
  {
    ACTIVE([vdvDeviceModule,PLAY_FB    ]) : RmsAssetParameterEnqueueSetValue(assetClientKey, 'transport.state', 'Play'    )
    ACTIVE([vdvDeviceModule,STOP_FB    ]) : RmsAssetParameterEnqueueSetValue(assetClientKey, 'transport.state', 'Stop'    )
    ACTIVE([vdvDeviceModule,PAUSE_FB   ]) : RmsAssetParameterEnqueueSetValue(assetClientKey, 'transport.state', 'Pause'   )
    ACTIVE([vdvDeviceModule,SFWD_FB    ]) : RmsAssetParameterEnqueueSetValue(assetClientKey, 'transport.state', 'Next'    )
    ACTIVE([vdvDeviceModule,SREV_FB    ]) : RmsAssetParameterEnqueueSetValue(assetClientKey, 'transport.state', 'Previous')
    ACTIVE([vdvDeviceModule,RECORD_FB  ]) : RmsAssetParameterEnqueueSetValue(assetClientKey, 'transport.state', 'Record'  )
    ACTIVE([vdvDeviceModule,SLOW_FWD_FB]) : RmsAssetParameterEnqueueSetValue(assetClientKey, 'transport.state', 'Slow Fwd')
    ACTIVE([vdvDeviceModule,SLOW_REV_FB]) : RmsAssetParameterEnqueueSetValue(assetClientKey, 'transport.state', 'Slow Rev')
  }
...
DEFINE_FUNCTION RegisterAssetParametersSnapiComponents(CHAR assetClientKey[])
{
  ...
  RmsAssetOnlineParameterEnqueue (assetClientKey, GetOnlineSnapiValue(dvMonitoredDevice));
  RmsAssetDataInitializedParameterEnqueue (assetClientKey, GetDataInitializedSnapiValue(dvMonitoredDevice));
...
DEFINE_FUNCTION INTEGER GetOnlineSnapiValue(DEV device)
{
  ...
  RETURN(DEVICE_ID(device) && [vdvDeviceModule,DEVICE_COMMUNICATING])
}
...
DEFINE_FUNCTION CHAR GetDataInitializedSnapiValue(DEV device)
{
  // the physical device must be online and the SNAPI
  // channel for DATA_INITIALIZED must be turned on
  RETURN(DEVICE_ID(device) && [vdvDeviceModule,DATA_INITIALIZED])
}
...
(************************************************************************************************************)
#IF_DEFINED HAS_POWER
  CHANNEL_EVENT[vdvDeviceModule,POWER_FB]
  {
    ON :
    {
#IF_DEFINED HAS_LAMP
...
#IF_DEFINED HAS_VOLUME
  CHANNEL_EVENT[vdvDeviceModule,VOL_MUTE_FB]
  {
    ON :
    {
      IF(IsRmsReady())
  ...
  LEVEL_EVENT[vdvDeviceModule,VOL_LVL]
  {
...
#IF_DEFINED HAS_GAIN
  CHANNEL_EVENT[vdvDeviceModule,GAIN_MUTE_FB]
  {
    ON :
    {
      IF(IsRmsReady())
  ...
  LEVEL_EVENT[vdvDeviceModule,GAIN_LVL]
  {
...
#IF_DEFINED HAS_PREAMP
  LEVEL_EVENT[vdvDeviceModule,BALANCE_LVL]
  LEVEL_EVENT[vdvDeviceModule,BASS_LVL   ]
  LEVEL_EVENT[vdvDeviceModule,TREBLE_LVL ]
  {
    IF(IsRmsReady())
    {
  ...
  CHANNEL_EVENT[vdvDeviceModule,LOUDNESS_FB]
  {
    ON :
    {
      IF(IsRmsReady())
...
#IF_DEFINED HAS_DIALER
  CHANNEL_EVENT[vdvDeviceModule,DIAL_OFF_HOOK_FB]
  CHANNEL_EVENT[vdvDeviceModule,DIAL_AUTO_ANSWER_FB]
  CHANNEL_EVENT[vdvDeviceModule,DIAL_AUDIBLE_RING_FB]
  {
    ON :
    {
      IF(IsRmsReady())
...
#IF_DEFINED HAS_CONFERENCER
  CHANNEL_EVENT[vdvDeviceModule,ACONF_PRIVACY_FB]
  {
    ON :
    {
      IF(IsRmsReady())
...
#IF_DEFINED HAS_CAMERA_PAN_TILT
  LEVEL_EVENT[vdvDeviceModule,PAN_LVL   ]
  LEVEL_EVENT[vdvDeviceModule,TILT_LVL  ]
  LEVEL_EVENT[vdvDeviceModule,PAN_SPEED_LVL ]
  LEVEL_EVENT[vdvDeviceModule,TILT_SPEED_LVL]
  {
    IF(IsRmsReady())
    {
      SWITCH(LEVEL.INPUT.LEVEL)
...
#IF_DEFINED HAS_CAMERA_LENS
  LEVEL_EVENT[vdvDeviceModule,ZOOM_LVL   ]
  LEVEL_EVENT[vdvDeviceModule,FOCUS_LVL  ]
  LEVEL_EVENT[vdvDeviceModule,IRIS_LVL   ]
  LEVEL_EVENT[vdvDeviceModule,ZOOM_SPEED_LVL ]
  LEVEL_EVENT[vdvDeviceModule,FOCUS_SPEED_LVL]
  LEVEL_EVENT[vdvDeviceModule,IRIS_SPEED_LVL ]
  {
    IF(IsRmsReady())
    {
      SWITCH(LEVEL.INPUT.LEVEL)
  ...
  CHANNEL_EVENT[vdvDeviceModule,AUTO_FOCUS_FB]
  CHANNEL_EVENT[vdvDeviceModule,AUTO_IRIS_FB ]
  {
    ON :
    {
      IF(IsRmsReady())
...
#IF_DEFINED HAS_DISC_TRANSPORT
  CHANNEL_EVENT[vdvDeviceModule,PLAY_FB    ]
  CHANNEL_EVENT[vdvDeviceModule,STOP_FB    ]
  CHANNEL_EVENT[vdvDeviceModule,PAUSE_FB   ]
  CHANNEL_EVENT[vdvDeviceModule,SFWD_FB    ]
  CHANNEL_EVENT[vdvDeviceModule,SREV_FB    ]
  CHANNEL_EVENT[vdvDeviceModule,RECORD_FB  ]
  CHANNEL_EVENT[vdvDeviceModule,SLOW_FWD_FB]
  CHANNEL_EVENT[vdvDeviceModule,SLOW_REV_FB]
  {
    ON :
    {
      IF(IsRmsReady())
