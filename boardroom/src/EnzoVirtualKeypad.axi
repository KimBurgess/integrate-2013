...
BUTTON8 = 'Lights Full'
BUTTON9 = 'Select PC'
BUTTON10 = 'Select Video Conferencer'
BUTTON11 = 'Select Audio Conferencer'
BUTTON12 = 'Select Document Camera'

ICON1 = 'volume-full'
ICON2 = 'arrow-circle-up'
ICON3 = 'volume-medium'
ICON4 = 'arrow-circle-down'
ICON5 = 'volume-mute'
ICON6 = 'lights-off'
ICON7 = 'lights-low'
ICON8 = 'lights-full'
...
DATA_EVENT [VIRTUALKEYPAD]
{
		...
		online:
    {
			...
			send_command VIRTUALKEYPAD, "'LABEL1-',BUTTON1,',',ICON1"
			send_command VIRTUALKEYPAD, "'LABEL2-',BUTTON2,',',ICON2"
			send_command VIRTUALKEYPAD, "'LABEL3-',BUTTON3,',',ICON3"
			send_command VIRTUALKEYPAD, "'LABEL4-',BUTTON4,',',ICON4"
			send_command VIRTUALKEYPAD, "'LABEL5-',BUTTON5,',',ICON5"
			send_command VIRTUALKEYPAD, "'LABEL6-',BUTTON6,',',ICON6"
			send_command VIRTUALKEYPAD, "'LABEL7-',BUTTON7,',',ICON7"
			send_command VIRTUALKEYPAD, "'LABEL8-',BUTTON8,',',ICON8"
			send_command VIRTUALKEYPAD, "'LABEL9-',BUTTON9,',',ICON9"
			send_command VIRTUALKEYPAD, "'LABEL10-',BUTTON10,',',ICON10"
			send_command VIRTUALKEYPAD, "'LABEL11-',BUTTON11,',',ICON11"
			send_command VIRTUALKEYPAD, "'LABEL12-',BUTTON12,',',ICON12"
    }
}
