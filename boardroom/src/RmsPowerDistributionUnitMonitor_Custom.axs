 ...
 *     as applicable.
*/
MODULE_NAME='RmsPowerDistributionUnitMonitor_Custom'(DEV vdvRMS,
                                              DEV dvMonitoredDevice,
                                              DEV dvPowerMonitoredAssets[],
											  CHAR temperatureSensorName[],
											  CHAR powerOutletNames[][11],
											  CHAR axLinkBusNames[][17])
...
(***********************************************************)
DEFINE_FUNCTION RmsEventRelayAssetRegistered(CHAR registeredAssetClientKey[], CHAR newAssetRegistration)
{
...
DEFINE_FUNCTION CHAR[15] GetTemperatureUnits()
{
  ...
  {
    RETURN "'Farenheit'";  // byte 167 is the degrees symbol in ASCII
  }
  ELSE
  {
    RETURN "'Celcius'";  // byte 167 is the degrees symbol in ASCII
  }
}
